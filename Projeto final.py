def adicionar_tarefa(lista_de_tarefas, tarefa):
    """Adicionar uma nova tarefa a uma lista pré-existente"""
...
while continuar:
    ...
    if opcao == "1":
        ...
        listar_tarefas(lista_de_tarefas)
         ...
         #A validação verifica se o valor é númerico, se é menor que o limite da lista e se é maior do que zero
